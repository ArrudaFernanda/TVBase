 ...
 * Use the {@link WatchlistFrag#newInstance} factory method to
...
public class WatchlistFrag extends Fragment {
    ...
    public static WatchlistFrag newInstance(String param1, String param2) {
        WatchlistFrag fragment = new WatchlistFrag();
